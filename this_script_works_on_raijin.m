...
BOM_data_array = cell(1,8);%This needs to be at least as long as the total number of files. Doesn't matter if it's longer.
parfor (f = 1:length(theFiles),  numberOfWorkers)
...
save('/g/data/xc0/user/walker/sjw603/scripts/test_cube.mat', 'test_cube')
